...
class AccountLoginIOSUI extends StatelessWidget {

  final AccountLoginViewModel ViewModel;

  const AccountLoginIOSUI(this.ViewModel);
          ...
          children: [
            ...
            Column(
              children: [
                ...
                ProviderWidget(ViewModel.SelectedMode.AppleLogoPath(), "Apple", ViewModel.LoginWithApple, 
                  ViewModel.SelectedLanguage, ViewModel.SelectedMode),
              ],
            ),
          ],
        ),
